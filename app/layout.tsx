...
export const metadata: Metadata = {
  metadataBase: new URL("https://constellation-encyclopedia.vercel.app"),
  title: {
    default: "Constellation Encyclopedia — 88 Constellations of the Night Sky",
    template: "%s | Constellation Encyclopedia",
  },
  description: "Interactive encyclopedia of all 88 constellations. Stars, legends, myths and how to find them in the night sky.",
  openGraph: {
