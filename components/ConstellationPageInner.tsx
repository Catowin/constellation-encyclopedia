    ...
    <main className="relative w-screen h-screen overflow-hidden" style={{ background: "#0a0e1a" }}>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="block md:hidden absolute rounded-full" style={{
          ...
          opacity: 0.6,
          filter: "blur(60px)",
          background: "radial-gradient(circle, rgba(80,90,220,0.9) 0%, rgba(120,80,200,0.5) 45%, transparent 70%)",
        }} />
        {/* Десктоп */}
      ...
      <div className="absolute inset-0 z-10">
        <AnimatePresence mode="wait" custom={dirRef.current}>
          <motion.div
            ...
            variants={{
              enter: (dir: "left" | "right") => ({ opacity: 0, x: dir === "right" ? 60 : -60 }),
              show:  { opacity: 1, x: 0 },
              exit:  (dir: "left" | "right") => ({ opacity: 0, x: dir === "right" ? -60 : 60 }),
            }}
            initial="enter"
            animate="show"
            exit="exit"
      ...
      {/* Кнопка нічного режиму — тільки мобільний */}
      <button
        onClick={() => setNightMode(v => !v)}
        className="md:hidden absolute top-5 left-5 z-30 p-2.5 rounded-full transition-all duration-300 focus:outline-none"
        style={{
          background: nightMode ? "rgba(180,0,0,0.25)" : "rgba(15,10,20,0.5)",
          border: `1px solid ${nightMode ? "rgba(220,0,0,0.4)" : "rgba(255,255,255,0.1)"}`,
        }}
      >
          ...
          >
            ...
            >
              ...
              <div className="flex-shrink-0 px-8 pt-7 pb-0 text-center">
                <p style={{ fontSize: 9, letterSpacing: "0.4em", color: "rgba(201,168,76,0.75)", fontFamily: "'Cormorant SC', Georgia, serif", marginBottom: 8 }}>
                  {L.constell}
                </p>
                <h2 style={{
                  fontFamily: "'Cormorant SC', Georgia, serif",
              ...
              <div className="flex flex-col md:flex-row overflow-hidden flex-1 min-h-0">
                ...
                <div className="flex-1 flex flex-col min-h-0">
                  ...
                  <div className="flex-shrink-0 flex items-center justify-between px-5 md:px-9 py-4"
      ...
      {/* Нічна вінєтка — тільки мобільний */}
      <AnimatePresence>
        {nightMode && (
          <motion.div
            initial={{ opacity: 0 }}
